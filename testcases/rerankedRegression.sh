...
then
    ...
    java -cp .:bin/:lib/*:conf/ edu.cmu.ml.praprolog.Experiment --programFiles ${PROGRAM%:} --train $DIR/toytrain.data --output $DIR/toytrain.cooked --test $DIR/toytest.data --params $DIR/params.wts --prover dpr --epochs 20 --tester rt | tee $DIR/log.log
