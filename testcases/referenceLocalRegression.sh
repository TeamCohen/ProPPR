...
then
    ...
    java -cp .:bin/:lib/*:conf/ edu.cmu.ml.praprolog.Experiment --programFiles ${PROGRAM%:} --trainer mrr --train $DIR/toytrain.data --output $DIR/toytrain.cooked --test $DIR/toytest.data --params $DIR/params.wts --prover dpr --epochs 83 --srw l2plocal | tee $DIR/log.log 
