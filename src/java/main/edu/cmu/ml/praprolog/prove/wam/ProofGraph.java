...
import edu.cmu.ml.praprolog.graph.IdentityIndex;
import edu.cmu.ml.praprolog.graph.LightweightStateGraph;
...
public class ProofGraph {
	...
	public PosNegRWExample<State> makeRWExample(Map<State, Double> ans) {
		...
		return new PosNegRWExample<State>(this.graph, queryVector, posIds, negIds);
	}
	/* ************************** de/serialization *********************** */
	
	public String serialize(PosNegRWExample<State> x) {
