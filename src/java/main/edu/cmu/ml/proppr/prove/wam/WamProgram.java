 ...
 *
 */
public class WamProgram extends AWamProgram {
	...
	public static AWamProgram load(File file) throws IOException {
		LineNumberReader reader = new LineNumberReader(new FileReader(file));
		return load(reader);
	}
	public static AWamProgram load(LineNumberReader reader) throws IOException {
