package edu.cmu.ml.proppr.trove.graph;
...
import edu.cmu.ml.proppr.trove.graph.Edge;
...
//	
	...
	public void testWTF() {
		int[][] edgestrs = {
			...
			{712,1}, {712,220}, {711,1}, {97,598}, {454,1},
			{454,222},{835,1},{161,1},{217,221},{1037,1},{484,1},
			{976,743},{1264,664},{1264,679},{1594,664},{1328,664},
			{721,664}
	...
	public void testBadPair() {
		Edge e = new Edge(976,743), f = new Edge(721,664);
		assertTrue(e.hashCode() != f.hashCode());
	}
	
	public void noDuplicates(Edge[] keys) {
		for (int i=0; i<keys.length; i++) {
			for (int j=(i+1); j<keys.length; j++) {
				assertTrue("ji equals "+i+","+j+" "+keys[j].toString()+" "+keys[i].toString(),!keys[j].equals(keys[i]));
