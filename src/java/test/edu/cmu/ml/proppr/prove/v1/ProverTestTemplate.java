...
import edu.cmu.ml.proppr.prove.v1.FeatureDictWeighter;
...
public abstract class ProverTestTemplate {
	...
	public void testProveState() {
		...
		Map<LogicProgramState,Double> dist = prover.proveState(lpMilk,new ProPPRLogicProgramState(Goal.decompile("isa,elsie,-1")));//("isa","elsie","X"));
