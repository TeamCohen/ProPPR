...
public class RerankingQueryAnswerer extends QueryAnswerer {
    ...
    public Map<LogicProgramState, Double> getSolutions(Prover prover, Goal query, LogicProgram program) {
        ...
        Map<String, LogicProgramState> graphIds = new HashMap<String, LogicProgramState>();
        ...
        Map<String, Double> start = new HashMap<String, Double>();
        start.put(writer.getId(new ProPPRLogicProgramState(query)), 1.0);
